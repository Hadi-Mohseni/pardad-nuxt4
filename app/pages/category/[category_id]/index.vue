<template>
  ...
  >
    <div class="relative grid grid-cols-9 w-full h-full lg:pt-[300px] pt-[150px]">
      ...
      <div class="lg:col-span-3 col-span-9  order-1 lg:order-2 ">
        <h1 class="lg:pr-4 md:pr-20 pr-4 text-right  pb-[25px] tracking-tighter lg:tracking-normal lg:pb-10 lg:before:content-none lg:after:content-none before:content-[''] before:left-0 before:bg-black-100/20 before:absolute before:bottom-0 before:right-0 before:h-[1px] after:content-[''] after:w-[8vw] after:bg-black-900 after:absolute after:bottom-0 after:right-[80px] after:h-[1px] text-[23px]  lg:text-[40px] lg:ml-10 xl2:ml-[300px]  lg:mb-0 font-light"
            ref="titleElement">
          {{ response.title }}
        </h1>
      </div>
