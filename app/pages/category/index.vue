...
<!--        <div class="border-t border-b mt-8 md:mt-0">
        ...
        <div v-else>
          <div v-if="updateBlogList && updateBlogList.length > 0"
               ref="bodyElement"
               class="h-full grid grid-cols-1 md:grid-cols-2 gap-x-6 w-full">
            ...
            >
              <nuxt-link :title="item.title"
                         class="relative overflow-hidden inline-block text-[#1e1e1e] group py-2 w-full"
              ...
              >
                ...
                <span :class="index % 2 !== 0 ? 'right-0' : 'left-0'"
                      class="absolute bottom-0 right-0 w-full h-px bg-black opacity-20"></span>
                <span
                    :class="index % 2 !== 0 ? 'right-[calc(100%-10px)] group-hover:right-0' : 'group-hover:left-0 left-[calc(100%-10px)]' "
