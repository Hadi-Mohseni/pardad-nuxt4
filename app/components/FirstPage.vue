...
.home__screen.fourth_page .separator {
  margin-right: 0;
  width: 18vw;
  align-self: flex-end;
  margin-top: 3vw;
...
@media screen and (min-width: 600px) {
  ...
  .home__screen.fourth_page .home__screen__title :first-child {
    color: #000
      /* font-size: 25px !important */
  }
}

.home__screen.fourth_page .separator .home__screen__separator {
  width: 100%;
  margin-bottom: 10px;
}

.home__screen.fourth_page .separator .home__screen__body__text {
  font-size: 15px;
  text-align: right;
  width: 100%;
}
