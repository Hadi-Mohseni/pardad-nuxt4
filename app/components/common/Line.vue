...
import {useLineVerticalAnimation} from "~/composables/useLineVerticalAnimation.js";

const line = ref(null);
const {create:createAnimation , handle , kill ,restart , start , updateTimeLine } = useLineVerticalAnimation()
...
<template>
  <div class="fixed top-0 bottom-0 left-[33.3%] w-[1px] min-h-[100vh] z-[2] "
    ...
    <div class="absolute top-0 left-0 w-full h-[28px] bg-[#323232] invisible origin-[left_top]"
         ref="lineRunner"></div>
  </div>
</template>
